...
```
Our files `print_array.c` and `print_list.c` (containing the `print_array` and `print_lis`t functions) will be compiled with your functions during the correction.
